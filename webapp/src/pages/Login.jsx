    ...
    <div className="auth">
      <div className="auth__container">
        <div className="auth__left">
          <Link to="/" className="auth__logo">Luxe Botanica</Link>
          <div className="auth__content">
            <h1>{isLogin ? 'Welcome Back' : 'Create Account'}</h1>
            <p>
              {isLogin
                ? 'Sign in to access your account and continue shopping.'
                : 'Join the Luxe Botanica family and discover natural beauty.'
              }
            </p>
        ...
        <div className="auth__right">
          ...
          <div className="auth__overlay">
            <div className="auth__quote">
              <blockquote>
                "Natural beauty is the best beauty. We believe in enhancing what nature gave you."
              </blockquote>
              <p>— Luxe Botanica</p>
            </div>
          </div>
